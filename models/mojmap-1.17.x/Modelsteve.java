...
public class Modelsteve<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 11).addBox(-8.0F, -5.0F, -5.0F, 7.0F, 1.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 3.1416F, 0.0F, 1.5708F));

		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 11)
						.addBox(-8.0F, 4.0F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(24, 22)
		...
		PartDefinition cube_r12 = Body.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(28, 37).addBox(-6.0F, -1.0F, -1.0F, 6.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 0.0F, -3.0F, 0.0436F, 1.5708F, -0.0873F));

		PartDefinition cube_r13 = Body.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(36, 0).addBox(-6.0F, -1.0F, -1.0F, 6.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = Body.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(42, 15).addBox(-6.0F, -1.0F, -1.0F, 6.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 0.0F, 3.0F, 0.2182F, -1.6144F, -0.0873F));

		PartDefinition cube_r15 = Body.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(42, 30).addBox(-6.0F, -1.0F, -1.0F, 6.0F, 14.0F, 1.0F,
						new CubeDeformation(0.0F)),
