...
public class Modelvengeful_spirit_bullet_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("hk", "modelvengeful_spirit_bullet_model"),
			"main");
	public final ModelPart Spirit;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Spirit = partdefinition.addOrReplaceChild("Spirit",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 7.0F, -3.0F, 2.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-2.0F, 4.0F, -5.25F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(1.0F, 4.0F, -5.25F, 1.0F, 2.0F,
								0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 16.0F, 0.0F, 0.0F, 1.5708F, 1.5708F));
		PartDefinition cube_r1 = Spirit.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(21, 0).addBox(-1.0F, 1.0F, -2.0F, 1.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)),
