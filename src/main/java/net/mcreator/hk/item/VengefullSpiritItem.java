...
public class VengefullSpiritItem extends Item {
	public VengefullSpiritItem() {
		super(new Item.Properties().tab(HkModTabs.TAB_HOLLOW_KNIGHT_TAB).durability(100));
		setRegistryName("vengefull_spirit");
	}
